...
package resource_management_router
...
func ManagementRouterResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ManagementRouter$"), ""),
				},
				Default: stringdefault.StaticString("ManagementRouter"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ManagementRouter",
				MarkdownDescription: "name of the ManagementRouter",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "ManagementRouterStatus defines the observed state of ManagementRouter",
			},
		},
	}
}

type ManagementRouterModel struct {
