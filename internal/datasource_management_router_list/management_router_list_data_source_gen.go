...
package datasource_management_router_list
...
func ManagementRouterListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ManagementRouterListModel struct {
