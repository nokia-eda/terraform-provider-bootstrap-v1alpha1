...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-bootstrap/internal/resource_init"
	"github.com/nokia/eda/apps/terraform-provider-bootstrap/internal/tfutils"
)

const (
	create_rs_init = "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/inits"
	read_rs_init   = "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/inits/{name}"
	update_rs_init = "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/inits/{name}"
	delete_rs_init = "/apps/bootstrap.eda.nokia.com/v1alpha1/namespaces/{namespace}/inits/{name}"
)

var (
	_ resource.Resource                = (*initResource)(nil)
	_ resource.ResourceWithConfigure   = (*initResource)(nil)
...
func (r *initResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_init"
}

func (r *initResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_init.InitResourceSchema(ctx)
}

func (r *initResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_init.InitModel
	...
	err = r.client.Create(ctx, create_rs_init, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_init, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *initResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_init, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *initResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_init, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *initResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
