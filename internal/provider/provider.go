...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-bootstrap/internal/eda/utils"
...
var _ provider.Provider = (*bootstrapProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &bootstrapProvider{version: ver}
	}
}
...
func (p *bootstrapProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *bootstrapProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *bootstrapProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "bootstrap-v1alpha1"
	resp.Version = p.version
}

func (p *bootstrapProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewInitDataSource,
		NewInitListDataSource,
		NewManagementRouterDataSource,
		NewManagementRouterListDataSource,
		NewResourceListDataSource,
	}
}

func (p *bootstrapProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewInitResource,
		NewManagementRouterResource,
	}
}
